...
func (c *linkShortenerClient) Create(ctx context.Context, in *LongURL, opts ...grpc.CallOption) (*ShortURL, error) {
	out := new(ShortURL)
	err := c.cc.Invoke(ctx, "/shortener.LinkShortener/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkShortenerClient) Get(ctx context.Context, in *ShortURL, opts ...grpc.CallOption) (*LongURL, error) {
	out := new(LongURL)
	err := c.cc.Invoke(ctx, "/shortener.LinkShortener/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLinkShortenerServer) Create(context.Context, *LongURL) (*ShortURL, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedLinkShortenerServer) Get(context.Context, *ShortURL) (*LongURL, error) {
...
func _LinkShortener_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.LinkShortener/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkShortenerServer).Create(ctx, req.(*LongURL))
	}
...
func _LinkShortener_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.LinkShortener/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkShortenerServer).Get(ctx, req.(*ShortURL))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LinkShortener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shortener.LinkShortener",
